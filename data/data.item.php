 ...
 * "buy"=>"ÇãÃÍ",
 * "img"=>"²èÁü",
 * "atk"=>array(ÊªÍý¹¶·â,ËâË¡¹¶·â),
 * "def"=>array(ÊªÍý³ä?,ÊªÍý¸º,ËâË¡³ä?,ËâË¡¸º),
 * "dh"=> true,//Î¾¼êÉð´ï¤«ÈÝ¤«( "D"ouble"H"and )
 * "handle"=>"¿ôÃÍ",
