...
?>
	...
	<div style="margin:15px">
		...
		<ul>
			<li>
				<a href="#mj">行動の多重判定について</a>
			</li>
			<li>
				<a href="#twenty">約20%の確率を作る。</a>
			</li>
			<li>
				<a href="#def">防御力の数値について。</a>
			</li>
			<li>
				<a href="#res">弱点属性と状態異常が少ない理由。</a>
			</li>
		</ul>
		<!-- ---------------------------------------------------------------- -->
		<a name="mj"></a>
		...
		<div style="margin:0 20px">
			...
			<p><img src="<?php echo HOF_Class_Icon::getImageUrl('mon_079', HOF_Class_Icon::IMG_CHAR); ?>" class="vcent">戦士系の場合だと...<img src="<?php echo HOF_Class_Icon::getImageUrl('mon_080', HOF_Class_Icon::IMG_CHAR_REV); ?>" class="vcent"></p>
			<table cellspacing="5">
				<tbody>
					<tr>
						<td>1</td>
...
HOF_Class_Skill::ShowSkillDetail(HOF_Model_Data::getSkill(9000))
...
HOF_Class_Skill::ShowSkillDetail(HOF_Model_Data::getSkill(3121))
...
HOF_Class_Skill::ShowSkillDetail(HOF_Model_Data::getSkill(3110))
...
HOF_Class_Skill::ShowSkillDetail(HOF_Model_Data::getSkill(1017))
...
HOF_Class_Skill::ShowSkillDetail(HOF_Model_Data::getSkill(1000))
