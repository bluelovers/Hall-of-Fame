...
class HOF_Class_Item_Smithy
{
	...
	function ReturnItem()
	{
		...
		if (!$this->refine && !$this->option0 && !$this->option1 && !$this->option2) return $this->base;

		// 少なくとも精錬されているか、オプションが有る場合
		$item = $this->base . sprintf("%02d", $this->refine) . $this->option0 . $this->option1 . $this->option2;
